...
import { CheckCircle2, ChevronDown, Globe, Smartphone, BarChart3, Database } from "lucide-react";
...
export default function ComunicacionesUnificadasPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Sí. Contamos con un Centro de Operaciones de Red (NOC) propio que monitorea tu enlace de Comunicaciones Unificadas 24/7/365, con atención telefónica y soporte técnico en sitio de inmediato en caso de cualquier incidente.",
    },
    {
        ...
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          ...
          <div className="lg:col-span-6 flex flex-col items-start text-left">
            ...
            <p className="text-lg text-blue-100/90 mb-8 max-w-xl">
              Eleva los resultados e imagen de tu negocio a través de la telefonía IP en la nube, la solución que te ayudará a crear menús de atención automatizados y flujos eficientes.
            </p>
            ...
            <div className="mb-10 w-full">
              ...
              <ul className="space-y-3.5">
                {[
                  "Gestionamiento y control total desde la nube.",
                  "Soporte técnico personalizado 24/7.",
                  "Acceso de administración compartida con el cliente.",
                  "Consultoría guiada para la elección de tu mejor solución.",
                  "Acompañamiento integral desde la elección hasta la implementación y soporte."
                ].map((benefit, idx) => (
      ...
      <section id="diferenciadores" className="w-full bg-[#0026ff] py-20 px-6 text-center relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              {
                icon: <Globe className="w-10 h-10 stroke-[1]" />,
                title: "Acceso Total",
                text: "Desde cualquier parte del mundo, con un punto o conexión vía Internet.",
              },
              {
                icon: <Smartphone className="w-10 h-10 stroke-[1]" />,
                title: "Acceso Multidispositivo",
                text: "Uso y acceso en múltiples dispositivos (mobile, tabletas, desktop, fijo).",
              },
              {
                icon: <BarChart3 className="w-10 h-10 stroke-[1]" />,
                title: "Plataforma de Gestión",
                text: "Acceso a plataforma de gestión y monitoreo del desempeño de llamadas de tus usuarios.",
              },
              {
                icon: <Database className="w-10 h-10 stroke-[1]" />,
                title: "Grabación y Almacenamiento",
                text: "Grabación y almacenamiento seguro de llamadas de hasta 90 días.",
              },
            ].map((diff, i) => (
