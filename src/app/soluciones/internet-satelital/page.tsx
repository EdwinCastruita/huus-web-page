...
import { CheckCircle2, ChevronDown, Shield, Clock, Settings, Car } from "lucide-react";
import Partners from "@/components/Partners";

export default function InternetSatelitalPage() {
  // Form state
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Sí. Contamos con un Centro de Operaciones de Red (NOC) propio que monitorea tu enlace de Internet Satelital 24/7/365, con atención telefónica y soporte técnico en sitio de inmediato en caso de cualquier incidente.",
    },
    {
      ...
      <section className="relative w-full min-h-[90vh] bg-gradient-to-b from-[#00041a] via-[#021085] to-[#0026ff] flex flex-col justify-center overflow-hidden px-6 pt-32 pb-20">
        ...
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          ...
          <div className="lg:col-span-6 flex flex-col items-start text-left">
            ...
            <p className="text-base sm:text-lg text-blue-100/90 mb-4 max-w-xl">
              Nuestro servicio de Internet Satelital ofrece una solución de conectividad robusta y de alto rendimiento, aprovechando la innovadora constelación de satélites de órbita baja.
            </p>
            <p className="text-sm sm:text-base text-blue-200/80 mb-8 max-w-xl">
              Ideal para empresas, organizaciones y usuarios que requieren una conexión confiable, principal o de respaldo, de alta velocidad en ubicaciones remotas o con infraestructura terrestre limitada.
            </p>
            ...
            <div className="mb-10 w-full">
              ...
              <ul className="space-y-3.5">
                {[
                  "Multi Tecnología de acceso redundante.",
                  "Tiempo de implementación récord.",
                  "Soporte en sitio especializado y rápido.",
                  "Soporte 24/7/365 prioritario.",
                  "Reportes de consumo detallados en tiempo real.",
                  "Fácil y rápida contratación de servicios."
                ].map((benefit, idx) => (
      ...
      <section id="diferenciadores" className="w-full bg-[#0026ff] py-20 px-6 text-center relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              {
                icon: <Shield className="w-10 h-10 stroke-[1]" />,
                title: "Confiabilidad",
                text: "Redundancia de conexión a Internet mediante internet satelital y SIM LTE.",
              },
              {
                icon: <Clock className="w-10 h-10 stroke-[1]" />,
                title: "Tiempo",
                text: "Tiempo de Instalación de servicio menor a 3 horas.",
              },
              {
                icon: <Settings className="w-10 h-10 stroke-[1]" />,
                title: "Gestión y Control",
                text: "Acceso personalizado a plataforma de administración de servicio incluido.",
              },
              {
                icon: <Car className="w-10 h-10 stroke-[1]" />,
                title: "Movilidad",
                text: "Instalación en unidades fijas o móviles de transporte.",
              },
            ].map((diff, i) => (
