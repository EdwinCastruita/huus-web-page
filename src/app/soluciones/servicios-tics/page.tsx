...
import { CheckCircle2, Settings, Lightbulb, TrendingUp } from "lucide-react";
import Partners from "@/components/Partners";

export default function ServiciosTicsPage() {
  ...
  const faqs = [
    ...
    { q: "¿Ofrecen soporte 24/7?", a: "Sí. Contamos con un NOC propio que monitorea tu servicio 24/7/365." },
    { q: "¿Pueden integrar múltiples enlaces?", a: "Por supuesto, diseñamos soluciones híbridas a medida." },
    { q: "¿Como empezaron?", a: "Nacimos para dar a las empresas conectividad robusta con tiempos de respuesta inmediatos." },
  ];
    ...
    <div className="w-full bg-[#00041a] text-white">
      <section className="relative w-full min-h-[90vh] bg-gradient-to-b from-[#00041a] via-[#021085] to-[#0026ff] flex flex-col justify-center overflow-hidden px-6 pt-32 pb-20">
        ...
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          <div className="lg:col-span-6 flex flex-col items-start text-left">
            <span className="text-cyan-400 font-bold tracking-widest text-sm uppercase mb-3 px-3 py-1 bg-cyan-400/10 rounded-full">Consultoría & TI</span>
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-black tracking-tight leading-none mb-6">
              Servicios<br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-blue-200 to-cyan-300">Tic's</span>
            </h1>
            <p className="text-lg text-blue-100/90 mb-8 max-w-xl">
              Los Hackers están siempre al acecho, ¿tu red está preparada para ellos? Con Xclen puedes tener tu información protegida, segura y a la mano.
            </p>
            <div className="mb-10 w-full">
              <h3 className="text-cyan-400 font-bold text-lg mb-4">Beneficios Huus:</h3>
              <ul className="space-y-3.5">
                {["Rápida implementación.", "Configuración a la medida.", "Análisis de comportamientos para prevención de ataques.", "Detección y Análisis de Tráfico.", "Gestión remota y posibilidad de administración compartida.", "Soporte 24/7.", "Análisis y dimensionamiento del equipo en base a las necesidades del cliente."].map((b, i) => (
          ...
          <div className="lg:col-span-6 flex justify-center">
            <div className="bg-white text-slate-900 w-full max-w-lg rounded-3xl p-6 sm:p-8 shadow-2xl">
              <h3 className="text-2xl font-black text-slate-800 mb-6 text-left">Solicita una Propuesta</h3>
              {submitted ? (
      ...
      <section id="diferenciadores" className="w-full bg-[#0026ff] py-20 px-6 text-center relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            {[
              { icon: <Settings className="w-10 h-10 stroke-[1]" />, title: "Personalización de Servicio", text: "Personalización de servicios en base a las necesidades del cliente." },
              { icon: <Lightbulb className="w-10 h-10 stroke-[1]" />, title: "Servicio de Consultoría", text: "Servicios de consultoría de acuerdo a los requerimientos de los clientes." },
              { icon: <TrendingUp className="w-10 h-10 stroke-[1]" />, title: "Mejora Continua", text: "Detección de posibles mejoras previo y durante la fase de implementación del servicio." },
            ].map((d, i) => (
      ...
      <section className="w-full bg-[#00041a] py-20 px-6 relative overflow-hidden">
        <div className="max-w-4xl mx-auto relative z-10">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-white text-right mb-16 tracking-tight pr-6 border-r-4 border-cyan-400">Preguntas Frecuentes</h2>
          <div className="space-y-4">
            {faqs.map((faq, idx) => (
              <div key={idx} className="w-full text-left rounded-2xl overflow-hidden">
