...
import { CheckCircle2, ChevronDown, Shuffle, Users, MapPin, Wifi } from "lucide-react";
import Partners from "@/components/Partners";

export default function InternetEventosPage() {
  // Form state
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Sí. Contamos con un Centro de Operaciones de Red (NOC) propio que monitorea tu enlace de Internet Eventos 24/7/365, con atención telefónica y soporte técnico en sitio de inmediato en caso de cualquier incidente.",
    },
    {
        ...
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          ...
          <div className="lg:col-span-6 flex flex-col items-start text-left">
            ...
            <p className="text-lg text-blue-100/90 mb-8 max-w-xl">
              ¿Buscas potenciar la información de los invitados a tu evento? Utiliza nuestra plataforma y red dedicada para lograr eso y mucho más.
            </p>
            ...
            <div className="mb-10 w-full">
              ...
              <ul className="space-y-3.5">
                {[
                  "Multi-Tecnología de acceso (Fibra y Microondas).",
                  "Implementación en - 6 horas.",
                  "Soporte técnico personalizado 24/7.",
                  "Generación de reportes y gráficas de consumo detalladas.",
                  "Generación de WiFi de alta capacidad para invitados."
                ].map((benefit, idx) => (
      ...
      <section id="diferenciadores" className="w-full bg-[#0026ff] py-20 px-6 text-center relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              {
                icon: <Shuffle className="w-10 h-10 stroke-[1]" />,
                title: "Adaptabilidad",
                text: "Nos adaptamos al tiempo de tu evento y a la velocidad que necesites.",
              },
              {
                icon: <Users className="w-10 h-10 stroke-[1]" />,
                title: "Acompañamiento",
                text: "Asistencia de personal técnico de guardia durante todo tu evento.",
              },
              {
                icon: <MapPin className="w-10 h-10 stroke-[1]" />,
                title: "Zonas Limitadas",
                text: "Entregamos el servicio incluso en zonas con difícil acceso de infraestructura.",
              },
              {
                icon: <Wifi className="w-10 h-10 stroke-[1]" />,
                title: "Conectividad WiFi",
                text: "Incluimos 2 access points de alta densidad con la contratación de tu servicio.",
              },
            ].map((diff, i) => (
