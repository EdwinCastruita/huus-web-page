...
import { CheckCircle2, ChevronDown, Wifi, Compass, Network, BarChart3 } from "lucide-react";
...
export default function RedWifiPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Sí. Contamos con un Centro de Operaciones de Red (NOC) propio que monitorea tu red WiFi 24/7/365, con atención telefónica y soporte técnico en sitio de inmediato en caso de cualquier incidente.",
    },
    {
        ...
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          ...
          <div className="lg:col-span-6 flex flex-col items-start text-left">
            ...
            <p className="text-lg text-blue-100/90 mb-8 max-w-xl">
              ¿Buscas potenciar la conectividad de tus invitados y colaboradores? Utiliza nuestra plataforma y red gestionada de alto rendimiento.
            </p>
            ...
            <div className="mb-10 w-full">
              ...
              <ul className="space-y-3.5">
                {[
                  "Estudio de capacidad requerida en sitio.",
                  "Generación de reportes detallados de cobertura.",
                  "Generación de diseño de red acorde a las necesidades del cliente.",
                  "Soporte técnico integral 24/7.",
                  "Administración compartida y transparente con el cliente."
                ].map((benefit, idx) => (
            ...
            {[
              {
                ...
                title: "WiFi a la Medida",
                text: "Creación de múltiples redes WiFi de acuerdo a las necesidades del cliente.",
              },
              {
                icon: <Compass className="w-10 h-10 stroke-[1]" />,
                title: "Inversión Inteligente",
                text: "Diseño de red pensado en el crecimiento de cobertura de red WiFi, habilitado para realizar upgrades de APs.",
              },
              {
                icon: <Network className="w-10 h-10 stroke-[1]" />,
                title: "Panorama de Red",
                text: "Análisis predictivo de la cobertura de la red WiFi en todo tu inmueble.",
              },
              {
                icon: <BarChart3 className="w-10 h-10 stroke-[1]" />,
                title: "Reporte de Red",
                text: "Generación de reportes de consumo de dispositivo, dentro de tu red corporativa.",
              },
            ].map((diff, i) => (
