...
import { CheckCircle2, Store, ArrowUpRight, Atom, BarChart3 } from "lucide-react";
...
export default function DataCentersPage() {
  ...
  const faqs = [
    { q: "¿En cuánto tiempo instalan?", a: "La integración de tu infraestructura en nuestros data centers se realiza de forma ágil, con un proceso guiado y tiempos acordados desde el contrato." },
    { q: "¿Ofrecen soporte 24/7?", a: "Sí. Contamos con personal técnico en sitio y NOC remoto 24/7/365 para garantizar la operación continua de tu infraestructura." },
    { q: "¿Pueden integrar múltiples enlaces?", a: "Sí, ofrecemos conectividad redundante con múltiples proveedores Tier 1 para garantizar disponibilidad máxima." },
    { q: "¿Como empezaron?", a: "Nacimos para dar a las empresas soluciones de alojamiento seguras, confiables y con alta disponibilidad." },
  ];
      ...
      <section className="relative w-full min-h-[90vh] bg-gradient-to-b from-[#00041a] via-[#021085] to-[#0026ff] flex flex-col justify-center overflow-hidden px-6 pt-32 pb-20">
        ...
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          <div className="lg:col-span-6 flex flex-col items-start text-left">
            <span className="text-cyan-400 font-bold tracking-widest text-sm uppercase mb-3 px-3 py-1 bg-cyan-400/10 rounded-full">Colocation & Hosting</span>
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-black tracking-tight leading-none mb-6">
              Data<br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-blue-200 to-cyan-300">Centers</span>
            </h1>
            <p className="text-base sm:text-lg text-blue-100/90 mb-8 max-w-xl leading-relaxed">
              Si requieres un servicio de alojamiento, que te permita operar con seguridad, capacidad ilimitada y dentro de instalaciones con Redundancia y Alta Disponibilidad, Xclen es la respuesta.
            </p>
            <div className="mb-10 w-full">
              <h3 className="text-cyan-400 font-bold text-lg mb-4">Beneficios Huus:</h3>
              <ul className="space-y-3.5">
                {[
                  "Accesos controlados y seguridad de circuito cerrado.",
                  "Planta de energía de respaldo garantizada.",
                  "Acceso 24/7 a tus instalaciones.",
                  "Apoyo y soporte técnico 24/7.",
                  "Ubicación personalizable según tus necesidades."
                ].map((b, i) => (
      ...
      <section id="diferenciadores" className="w-full bg-[#0026ff] py-20 px-6 text-center relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { icon: <Store className="w-10 h-10 stroke-[1]" />, title: "Redundancia", text: "Ubicación e instalaciones propias con energía y conectividad redundante." },
              { icon: <ArrowUpRight className="w-10 h-10 stroke-[1]" />, title: "Escalabilidad", text: "Flexibilidad de crecimiento de servicio en base a las necesidades del cliente." },
              { icon: <Atom className="w-10 h-10 stroke-[1]" />, title: "Conectividad", text: "Conectividad o redundancia con opción de proveedores Tier 1." },
              { icon: <BarChart3 className="w-10 h-10 stroke-[1]" />, title: "Centros Tier", text: "No hay límite en la transferencia de datos en ningún sentido." },
            ].map((d, i) => (
