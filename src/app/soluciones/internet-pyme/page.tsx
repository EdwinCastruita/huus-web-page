...
import { CheckCircle2, ChevronDown, ShieldCheck, Wifi, Compass, Network, Cpu, Radio } from "lucide-react";
import Partners from "@/components/Partners";

export default function InternetPymePage() {
  // Form state
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Sí. Contamos con un Centro de Operaciones de Red (NOC) propio que monitorea tu enlace de Internet Pyme 24/7/365, con atención telefónica y soporte técnico en sitio de inmediato en caso de cualquier incidente.",
    },
    {
        ...
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          ...
          <div className="lg:col-span-6 flex flex-col items-start text-left">
            ...
            <p className="text-lg text-blue-100/90 mb-8 max-w-xl">
              Una solución personalizada de Internet de Alta Disponibilidad, para cualquier tamaño de negocio o proyecto, la respuesta que buscabas.
            </p>
            ...
            <div className="mb-10 w-full">
              ...
              <ul className="space-y-3.5">
                {[
                  ...
                  "Generación de WiFi para invitados."
                ].map((benefit, idx) => (
            ...
            {[
              {
                ...
                text: "Conexión estable de alta calidad sin interrupciones.",
              },
              {
                icon: <Compass className="w-10 h-10 stroke-[1]" />,
                title: "Mejor Experiencia de Navegación",
                text: "Rutas cortas hacia internet. Con baja latencia, mayor velocidad.",
              },
              {
                icon: <Wifi className="w-10 h-10 stroke-[1]" />,
                title: "Ancho de Banda",
                text: "Servicio con baja sobre-suscripción.",
              },
              {
                icon: <Cpu className="w-10 h-10 stroke-[1]" />,
                title: "Tecnología de Última Generación",
                text: "Equipos de entrega con tecnología innovadora y de altas prestaciones. Facilidad de incrementar capacidades.",
              },
            ].map((diff, i) => (
