...
import { CheckCircle2, ChevronDown, Network, Radio, HardDrive, LineChart, Shield, ShieldCheck, Mail, Phone, MapPin, Send } from "lucide-react";
import Partners from "@/components/Partners";

export default function InternetDedicadoPage() {
  // Form state
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Sí. Contamos con un Centro de Operaciones de Red (NOC) propio que monitorea tu enlace de Internet Dedicado 24/7/365, con atención telefónica y soporte técnico en sitio de inmediato en caso de cualquier incidente.",
    },
    {
        ...
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          ...
          <div className="lg:col-span-6 flex flex-col items-start text-left">
            ...
            <p className="text-lg text-blue-100/90 mb-8 max-w-xl">
              Conexión simétrica, con 99.97% de disponibilidad y adaptada para brindarte un servicio a la medida de tu organización.
            </p>
            ...
            <div className="mb-10 w-full">
              ...
              <ul className="space-y-3.5">
                {[
                  "Proceso de contratación fácil y rápido.",
                  "Implementación en - 6 horas.",
                  "Soporte técnico personalizado 24/7.",
                  "Garantía de servicio por contrato (SLA).",
                  "Línea directa con tu ejecutivo de atención a clientes.",
                  "Asesoría y soporte en sitio con nuestro equipo de expertos."
                ].map((benefit, idx) => (
      ...
      <section id="diferenciadores" className="w-full bg-[#0026ff] py-20 px-6 text-center relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              {
                icon: <Network className="w-10 h-10 stroke-[1]" />,
                title: "Operadoras Tier 1",
                text: "Contamos con conexiones directas a operadoras de Internet Tier 1.",
              },
              {
                icon: <Radio className="w-10 h-10 stroke-[1]" />,
                title: "Microonda y Fibra Óptica",
                text: "Entrega de servicios mediante microonda y fibra óptica. Con flexibilidad de capacidades.",
              },
              {
                icon: <HardDrive className="w-10 h-10 stroke-[1]" />,
                title: "Mas Capacidad",
                text: "Capacidades de entrega de servicio dependiendo las necesidades del cliente desde 50 megas hasta Multi Gigas.",
              },
              {
                icon: <LineChart className="w-10 h-10 stroke-[1]" />,
                title: "Monitoreo de tu Red",
                text: "Generación de reportes y gráficas detalladas de consumo de tu servicio.",
              },
            ].map((diff, i) => (
