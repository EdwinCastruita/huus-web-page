...
import { CheckCircle2, Search, Cloud, Activity, RefreshCw } from "lucide-react";
...
export default function SdWanPage() {
  ...
  const faqs = [
    { q: "¿En cuánto tiempo instalan?", a: "La implementación remota de SD-WAN puede realizarse en horas, sin necesidad de visitas técnicas en sitio para configuraciones estándar." },
    { q: "¿Ofrecen soporte 24/7?", a: "Sí. Contamos con un NOC propio que monitorea tu red SD-WAN 24/7/365 con atención telefónica inmediata." },
    { q: "¿Pueden integrar múltiples proveedores?", a: "Sí, esa es la esencia de SD-WAN: integramos y optimizamos múltiples proveedores de Internet en un solo equipo inteligente." },
    { q: "¿Como empezaron?", a: "Nacimos para dar a las empresas conectividad robusta y automatizada con tiempos de respuesta inmediatos." },
  ];
      ...
      <section className="relative w-full min-h-[90vh] bg-gradient-to-b from-[#00041a] via-[#021085] to-[#0026ff] flex flex-col justify-center overflow-hidden px-6 pt-32 pb-20">
        ...
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          <div className="lg:col-span-6 flex flex-col items-start text-left">
            <span className="text-cyan-400 font-bold tracking-widest text-sm uppercase mb-3 px-3 py-1 bg-cyan-400/10 rounded-full">Red Inteligente</span>
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-black tracking-tight leading-none mb-6">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-blue-200 to-cyan-300">SD-WAN</span>
            </h1>
            <p className="text-base sm:text-lg text-blue-100/90 mb-8 max-w-xl leading-relaxed">
              La solución de Alta Disponibilidad que minimiza y reduce un posible corte de servicio, derivado de una falla o degradación de alguno de los proveedores de Internet conectados al equipo. Con esto se garantiza la continuidad operativa de forma rápida y automática.
            </p>
            <div className="mb-10 w-full">
              <h3 className="text-cyan-400 font-bold text-lg mb-4">Beneficios Huus:</h3>
              <ul className="space-y-3.5">
                {[
                  "Flexibilidad de operación con múltiples proveedores de Internet.",
                  "Tiempo de implementación remota rápida y fácil.",
                  "Soporte técnico 24/7.",
                  "Reportes de consumo históricos y en tiempo real.",
                  "No está limitado solamente a nuestra cobertura."
                ].map((b, i) => (
            ...
            <div className="bg-white text-slate-900 w-full max-w-lg rounded-3xl p-6 sm:p-8 shadow-2xl">
              ...
              {submitted ? (
                <div className="py-12 flex flex-col items-center text-center">
                  ...
                  <p className="text-slate-500 text-sm max-w-xs">Tu asesor técnico te contactará en un plazo máximo de 6 horas.</p>
                </div>
              ) : (
      ...
      <section id="diferenciadores" className="w-full bg-[#0026ff] py-20 px-6 text-center relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { icon: <Search className="w-10 h-10 stroke-[1]" />, title: "Inspección Profunda", text: "Visión de uso de servicio de Internet. Segmentación por categorías o páginas web." },
              { icon: <Cloud className="w-10 h-10 stroke-[1]" />, title: "Gestión en Nube", text: "Notificaciones de estado y desempeño de tus enlaces en tiempo real." },
              { icon: <Activity className="w-10 h-10 stroke-[1]" />, title: "Monitoreo Libre", text: "Acceso a reportes históricos del consumo y desempeño de tus conexiones a Internet." },
              { icon: <RefreshCw className="w-10 h-10 stroke-[1]" />, title: "Equipo Compatible", text: "Integración y optimización de otros proveedores de Internet a nuestros equipos." },
            ].map((d, i) => (
